...
def main():
    ...
    # need to be deleted if you want to run the predict.py
    parser.add_argument("--m_pool_out", type=int, default=256, help='output dim of pooling')
    parser.add_argument("--m_feature_out", type=int, default=50280, help='output feature dim of mamba')
